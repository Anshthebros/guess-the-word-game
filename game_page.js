...
function send() {
	...
	*/
	...
	for (i = 0; i < word.length; i++) {
		if (i % 2 != 0) {
			words[j + 1] = words[j].replace(words[j].charAt(i), "_");
			j++;
		}
	}
	console.log(words[words.length - 1]);
	question_word = "<h4 id='word_display'> Q. " + words[words.length - 1] + "</h4>";
...
function check() {
	document.getElementById("la").style.display="inline-block";
